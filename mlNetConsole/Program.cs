...
namespace mlNetConsole
{
    ...
    //    static string SubscriptionKey = Environment.GetEnvironmentVariable("45c714d75ff847fd8e45719009d766d6");
    //    static string Endpoint = Environment.GetEnvironmentVariable("https://australiaeast.api.cognitive.microsoft.com/");
     ...
     */
        ...
        public static async Task DetectDomainSpecific(ComputerVisionClient client, string urlImage, string localImage)
        {
            ...
            Console.WriteLine();
            Console.WriteLine(resultJsonUrl);
            Console.WriteLine();
